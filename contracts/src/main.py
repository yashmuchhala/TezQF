...
class DAO(sp.Contract):
    ...
    def executeTokenMintProposal(self):
        ...
        sp.if (((proposal.votesYes - proposal.votesNo) > self.data.minimumVoteDifference) & (sp.len(proposal.voters) >= self.data.minTokenMintProposalVotes)):
        ...
        sp.for voter in proposal.voters.keys():
            sp.transfer(
                sp.record(
                    to_ = voter,
    ...
    def settleDispute(self, params):
        ...
        sp.for voter in dispute.voters.keys():
            sp.transfer(
                sp.record(
                    to_ = voter,
                    from_ = sp.to_address(sp.self), 
