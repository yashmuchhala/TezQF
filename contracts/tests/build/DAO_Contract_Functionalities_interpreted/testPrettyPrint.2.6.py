...
class Contract(sp.Contract):
  ...
  def contribute(self, params):
    ...
    self.data.rounds[self.data.currentRound].entries[params.entryId].contributions.push(sp.record(address = sp.sender, amount = sp.fst(sp.ediv(sp.amount, sp.tez(1)).open_some()), clrMatch = sp.tez(0)))
  ...
  def disburse(self, params):
    ...
    sp.send(self.data.daoContractAddress, totalSponsorship.value)
